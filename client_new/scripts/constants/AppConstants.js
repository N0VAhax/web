define(['lib/key-mirror'], function(KeyMirror){
    ...
    return {
        ...
        Engine: {
            ...
            HOST: (window.document.location.host === 'www.bustabit.com' || window.DEV_OTT) ? 'https://g2.moneypot.com:443' : window.document.location.host.replace(/:4000$/, ':3842'),
            CHAT_HOST: window.document.location.host,
            MAX_BET: 5e10 /** Max bet per game 1,000,000 Bits (now 50 ETH), this will be calculated dynamically in the future, based on the invested amount in the casino **/
        },
        ...
        Animations: {
            NYAN_CAT_TRIGGER_MS: 1000 //115129ms ~ 1000x // 11552ms ~ 2x
        }
