  define([
    ...
    var _currentUnitName = 'mETH';
    var _currentUnitValue = 10000;
    ...
    var GameSettingsStore = _.extend({}, Events, {
        ...
        getCurrentUnit: function() {
            return {
                ...
                unitValue:  _currentUnitValue
            }
        },

        moveToNextUnit: function() {
            var conversionTable = {
                'mETH': 'mETH'
            }
            var valueOfUnits = {
            ...
            _currentUnitName = conversionTable[_currentUnitName];
            _currentUnitValue = valueOfUnits[_currentUnitName];
        },
    ...
    AppDispatcher.register(function(payload) {
        ...
        switch(action.actionType) {
            ...
            case AppConstants.ActionTypes.TOGGLE_UNIT:
                GameSettingsStore.moveToNextUnit();
                GameSettingsStore.emitChange();
                break;
