    ...
    return React.createClass({
        ...
        render: function() {
            ...
            return D.div({ id: 'chart-inner-container', className: this.props.controlsSize, ref: 'container' },
                ...
                D.div({ className: 'rocket', style: {position: 'absolute', border: '0px solid blue;'} },
                  D.img({ style: {border: '0px solid red;'},
                      src: '../../img/rocket_eth.svg'
                  })
                ),
                ...
                D.div({ className: 'max-profit' },
                    'Max profit: ', (Engine.maxWin/1e9).toFixed(4), ' ETH'
                ),
