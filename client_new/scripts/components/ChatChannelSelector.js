define([
    ...
    return React.createClass({
        ...
        render: function() {
            ...
            var chans = ['china', 'japan', 'south-korea', 'united-kingdom'];
            // var chanLabels = ['china', 'japan', 'south-korea', 'united-kingdom' ];
            ...
            var flagRows = [];
            chans.forEach(function(channel, index) {
                flagRows[index] = D.div({ className: 'flags-row', key: 'row-' + index, onClick: self._selectChannel(channel)},
                        D.div({ className: 'channel-img-container' }, 
                            D.img({
                        ...
                        // D.div({ className: 'channel-span-container' },
                        //     D.span({ className: 'channel-label'}, chanLabels[index])
                        // )
