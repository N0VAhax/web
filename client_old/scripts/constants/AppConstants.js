define(['lib/key-mirror'], function(KeyMirror){
    ...
    return {
        ...
        Engine: {
            ...
            HOST: (window.document.location.host === 'www.bustabit.com' || window.document.location.host === 'www.moneypot.com') ? 'https://g2.moneypot.com' : window.document.location.host.replace(/:4000$/, ':3842'),
