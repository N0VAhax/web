define([
    ...
    return React.createClass({
        ...
        render: function() {
            ...
            var totalBets = (betSum(usersWonCashed) + betSum(usersLostPlaying))/100;
            return D.div(null, 
                D.div({ className: containerClass },
                ...
                D.div({ className: 'players-footer' },
                    D.div({ className: 'number-players' }, "Players: "+numberOfPlayers),
                    D.div({ className: 'number-betting' }, "Betting: "+totalBets)
                )
            );
        }
