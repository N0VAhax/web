define([
    ...
    Graph.prototype.drawGameData = function() {
        ...
        if(this.engine.gameState === 'ENDED') {
            ...
            var tableHistory = this.engine.tableHistory;
            var game_crash = tableHistory.length? tableHistory[0].game_crash : 0;
            this.ctx.fillText('@ ' + Clib.formatDecimals(game_crash/100, 2) + 'x', this.canvasWidth/5, 180);
        }
