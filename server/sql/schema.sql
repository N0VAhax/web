...
CREATE FUNCTION profit_users_stats_trigger() RETURNS trigger
  LANGUAGE plpgsql
  AS $$
BEGIN
...
CREATE TRIGGER profit_users_stats_trigger
AFTER UPDATE OF net_profit ON users
    FOR EACH ROW EXECUTE PROCEDURE profit_users_stats_trigger();
